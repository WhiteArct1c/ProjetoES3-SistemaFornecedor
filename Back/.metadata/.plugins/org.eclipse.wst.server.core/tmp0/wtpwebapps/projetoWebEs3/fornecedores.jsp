    ...
    <main class="d-flex flex-nowrap">
       ...
       <!--menu sidebar principal-->
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <li>
                <a href="CarregarFornecedores" class="nav-link active text-white">
        ...
        <div class="container-fluid">
          	<div class="row justify-content-center">
          		<div class="col-auto">
          			<h1 class="display-1 text-center fw-semibold">Fornecedores</h1>
          		</div>  	         		
			</div>
			<div class="row">
				<div class="col-auto">	
					<button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalFornecedor">
              		...
              		<form action="controller" method=post>
              			<tr>
              				...
              				<td>
                				...
                				<a class="btn btn-danger" href="/projetoWebEs3/controller?acao=Excluir&viewHelper=FornecedorVH&idFornecedor=<%=fornecedor.getId()%>" title="Excluir">
                    ...
                    <form class="needs-validation" action="controller" method="post">
                    	<div class="modal-body">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="cnpjFornecedor" name="cnpjFornecedor"  placeholder="Ex.: 09.999.999/9999-99" required>
							</div>
							<div class="mb-3">
								<div class="mb-3">
  									<label for="razaosocialFornecedor" class="form-label">Razão Social</label>
  									<input type="text" class="form-control" id="razaosocialFornecedor" name="razaosocialFornecedor" required>
								</div>
							</div>
							<div class="mb-3">
